...
export default function PersonWallpaperCard({ wallpaper }) {
  ...
  return (
    <motion.div whileHover={{ scale: 1.03 }} className="rounded-3xl bg-dark-card overflow-hidden shadow-2xl w-[260px] flex-shrink-0">
      <ProgressiveImage src={wallpaper.image_url} alt="Person wallpaper" className="h-56" />
      <div className="p-4">
        {wallpaper.resolution && <p className="text-xs text-gray-400 mb-2">{wallpaper.resolution}</p>}
