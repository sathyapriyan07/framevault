...
export default function LogoCard({ logo }) {
  ...
  return (
    <div className="rounded-lg bg-dark-card overflow-hidden shadow-sm w-[150px] md:w-[200px] lg:w-[240px] flex-shrink-0">
        ...
        <div className="flex gap-1.5">
          {pngUrl && (
            <button
              ...
              className="flex-1 rounded-full bg-blue-600 px-2 py-1 text-[10px] md:text-xs text-white font-medium"
            >
              PNG
            </button>
          )}
          {svgUrl && (
            <button
              ...
              className="flex-1 rounded-full bg-green-600 px-2 py-1 text-[10px] md:text-xs text-white font-medium"
            >
              SVG
            </button>
          )}
