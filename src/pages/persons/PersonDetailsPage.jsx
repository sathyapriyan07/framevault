    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col lg:flex-row gap-10 mb-12">
        ...
        <div className="flex-1">
          <h1 className="text-4xl font-heading font-bold mb-3">{person.name}</h1>
          {person.known_for && <p className="text-sm text-blue-300 mb-4">{person.known_for}</p>}
      ...
      <section>
        <h2 className="text-2xl font-heading font-semibold mb-6">Wallpapers</h2>
        {wallpapers.length === 0 ? (
